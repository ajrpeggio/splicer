...
# Change ownership of the config file without sudo (already owned by user)
chown "$(whoami):staff" "${config}"

echo "Configuration file created at ${config} with the following values:"
echo "Splice Folder: $splice"
echo "Final / Destination Folder: $final"
